...
DATA SEGMENT PARA 'DATA'
	...
	TEXT_MAIN_MENU_TITLE DB 'PLAYER 1 w s Player 2 o l' , '$' ;text with the main menu title
	TEXT_MAIN_MENU_STARTS DB 'STARTS - S KEY','$' ;text with the STARTS message
...
;       Shows the STARTS message
		...
		MOV AH,09h                       ;WRITE STRING TO STANDARD OUTPUT
		LEA DX,TEXT_MAIN_MENU_STARTS      ;give DX a pointer 
		INT 21h                          ;print the string
